...
const DreamGraph = forwardRef(({ initialNodes, resetCamera, onHover, onNodesChange, onSpawnSearchResults, onSpawnRelatedNodes }, ref) => {
  ...
  }, [nodes, hoveredNode, handleNodeClick, onHover, centeredNode]);
